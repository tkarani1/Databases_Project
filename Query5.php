...
$this_word = $_POST['this_word'];

echo "<h2>Songs by Artist With a Special Word</h2>";
//Determine if any input was actually collected
if (empty($this_artist)) {
    echo "No artist name provided <br><br>";
 
 } elseif (empty($this_word)){
   ...
   //  echo $item."<br><br>";
    ...
    if ($stmt = $conn->prepare(
     ...
     SELECT songName
       ...
       $stmt->bind_param("ss", $this_artist, $this_word);
       ...
       if ($stmt->execute()) {
        ...
        //if ($result->num_rows == 0) {
           ...
           echo "No info found for this artist and/or word";
